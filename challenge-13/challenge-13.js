(function(){
    ...
    */
    ...
    brasil.unshift('Roraima', 'Amapá', 'Pará');
    console.log(brasil);
    ...
    */
    ...
    var maisDeSete = brasil.every(function(item){
        return item.length > 7;
    });

   console.log(maisDeSete ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var cearaIncluido = brasil.some(function(item){
        return item === 'Ceará';
    });
