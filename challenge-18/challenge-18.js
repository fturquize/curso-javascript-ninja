(function(){
    ...
    */
    ...
    console.log(
        '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(/<(\w+)>([^<]+)<\/\w+>/g, function(string, tag, value){
            return '<'+ tag +'>O texto dentro da tag "'+ tag +'" é "' + value + '"</'+ tag +'>\n';
        })
    );
})();
