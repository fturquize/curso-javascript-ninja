(function(){
	...
	*/
	function sum(){
		...
		return Array.prototype.reduce.call(arguments, function(accumulated, current){
			return Number(accumulated) + Number(current);
		});
	}
	...
	*/
	...
	console.log(sum(4, 13, 54));
	console.log(sum(44, 1));
	console.log(sum(7, 0, 1, 8, 7));
